package de.aktienmathematik.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.aktienmathematik.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.aktienmathematik.repository.UserRepository.USERS_BY_EMAIL_CACHE);
